    ...
    on_supported_os.each do |os, facts|
      context "on #{os}" do
        ...
        context "pg_monz class without any parameters" do
          ...
          it { should contain_class('pg_monz::install').that_comes_before('pg_monz::config')}
          it { should contain_class('pg_monz::config').that_notifies('pg_monz::service')}
          it { should contain_class('pg_monz::service').that_subscribes_to('pg_monz::config') }
